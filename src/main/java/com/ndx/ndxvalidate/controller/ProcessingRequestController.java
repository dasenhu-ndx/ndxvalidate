...
public class ProcessingRequestController {
    ...
    public ProcessingRequestController(MiniChecksRepo miniChecksRepo, RunRequestRepo runRequestRepo, AccountRequestRepo accountRequestRepo, ProcessRequestService processRequestService, NdxModeService ndxModeService, DateTimeService dateTimeService) {
